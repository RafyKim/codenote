...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Note.topic'
        db.delete_column(u'note_note', 'topic_id')
        ...
        db.alter_column(u'note_topic', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['note.CodenoteUser'], null=True))

    def backwards(self, orm):
        # Adding field 'Note.topic'
        db.add_column(u'note_note', 'topic',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['note.Topic'], null=True, blank=True),
                      keep_default=False)
        ...
        # User chose to not deal with backwards NULL issues for 'Topic.user'
        raise RuntimeError("Cannot reverse this migration. 'Topic.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Topic.user'
        db.alter_column(u'note_topic', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['note.CodenoteUser']))
